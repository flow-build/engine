...
const acitivity_managers = require("../../../workflow/activity_manager");
...
describe("activity_manager_factory", () => {
    describe("getActivityManager", () => {
        it("Without a type it should return the ActivityManager", () => {
            ...
            expect(activity_manager).toBeInstanceOf(acitivity_managers.ActivityManager);
        })
        ...
        it("With type 'notify' it should return the NotifyActivityManager", () => {
            ...
            expect(activity_manager).toBeInstanceOf(acitivity_managers.NotifyActivityManager);
        })
